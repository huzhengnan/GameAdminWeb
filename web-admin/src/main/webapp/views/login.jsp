...
<div class="container-fluid">	    
    ...
    <div class="dialog">
        ...
        <div class="block">
            ...
            <div class="block-body">
                <form name="loginForm" method="post" action="${ctxPage}/login">
                    <label>账号</label>
                    <input type="text" class="span12" name="username" value="${userName}" required="true" autofocus="true">
                    <label>密码</label>
					...
					<a href="#"><img title="验证码" id="verify_code" src="${ctxPage}/validate" style="vertical-align:top"></a>
					<div class="clearfix"><input type="checkbox" name="rememberMe" value="remember-me"> 记住我 
        ...
        <p class="pull-right" style=""><a href="www.baidu.com" target="blank"></a></p>
    </div>
