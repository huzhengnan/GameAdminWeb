...
import com.lyh.admin.alipay.response.AlipayOpenPublicPersonalizedMenuDeleteResponse;
...
public class AlipayOpenPublicPersonalizedMenuDeleteRequest implements AlipayRequest<AlipayOpenPublicPersonalizedMenuDeleteResponse> {
	...
	* 个性化菜单删除
	...
	public Class<AlipayOpenPublicPersonalizedMenuDeleteResponse> getResponseClass() {
		return AlipayOpenPublicPersonalizedMenuDeleteResponse.class;
	}
