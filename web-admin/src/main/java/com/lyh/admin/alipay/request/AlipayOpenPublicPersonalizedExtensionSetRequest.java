...
import com.lyh.admin.alipay.response.AlipayOpenPublicPersonalizedExtensionSetResponse;
...
public class AlipayOpenPublicPersonalizedExtensionSetRequest implements AlipayRequest<AlipayOpenPublicPersonalizedExtensionSetResponse> {
	...
	* 个性化扩展区上下线接口
	...
	public Class<AlipayOpenPublicPersonalizedExtensionSetResponse> getResponseClass() {
		return AlipayOpenPublicPersonalizedExtensionSetResponse.class;
	}
