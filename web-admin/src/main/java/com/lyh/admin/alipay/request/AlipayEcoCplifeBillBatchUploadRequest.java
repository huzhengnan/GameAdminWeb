...
import com.lyh.admin.alipay.response.AlipayEcoCplifeBillBatchUploadResponse;
...
public class AlipayEcoCplifeBillBatchUploadRequest implements AlipayRequest<AlipayEcoCplifeBillBatchUploadResponse> {
	...
	* 物业费账单数据批量上传
	...
	public Class<AlipayEcoCplifeBillBatchUploadResponse> getResponseClass() {
		return AlipayEcoCplifeBillBatchUploadResponse.class;
	}
