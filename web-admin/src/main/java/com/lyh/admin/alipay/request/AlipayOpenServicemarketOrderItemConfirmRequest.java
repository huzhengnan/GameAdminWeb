...
import com.lyh.admin.alipay.response.AlipayOpenServicemarketOrderItemConfirmResponse;
...
public class AlipayOpenServicemarketOrderItemConfirmRequest implements AlipayRequest<AlipayOpenServicemarketOrderItemConfirmResponse> {
	...
	* 服务商代商家确认完成
	...
	public Class<AlipayOpenServicemarketOrderItemConfirmResponse> getResponseClass() {
		return AlipayOpenServicemarketOrderItemConfirmResponse.class;
	}
