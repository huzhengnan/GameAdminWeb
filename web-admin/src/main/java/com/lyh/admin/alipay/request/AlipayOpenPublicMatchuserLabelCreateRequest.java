...
import com.lyh.admin.alipay.response.AlipayOpenPublicMatchuserLabelCreateResponse;
...
public class AlipayOpenPublicMatchuserLabelCreateRequest implements AlipayRequest<AlipayOpenPublicMatchuserLabelCreateResponse> {
	...
	* 匹配用户标签添加接口
	...
	public Class<AlipayOpenPublicMatchuserLabelCreateResponse> getResponseClass() {
		return AlipayOpenPublicMatchuserLabelCreateResponse.class;
	}
