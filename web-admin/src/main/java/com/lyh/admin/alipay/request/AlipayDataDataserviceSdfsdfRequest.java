...
import com.lyh.admin.alipay.response.AlipayDataDataserviceSdfsdfResponse;
...
public class AlipayDataDataserviceSdfsdfRequest implements AlipayRequest<AlipayDataDataserviceSdfsdfResponse> {
	...
	public Class<AlipayDataDataserviceSdfsdfResponse> getResponseClass() {
		return AlipayDataDataserviceSdfsdfResponse.class;
	}
