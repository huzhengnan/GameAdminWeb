...
import com.lyh.admin.alipay.response.AlipayEcoMycarDataExternalQueryResponse;
...
public class AlipayEcoMycarDataExternalQueryRequest implements AlipayRequest<AlipayEcoMycarDataExternalQueryResponse> {
	...
	* 行业平台外部查询请求
	...
	public Class<AlipayEcoMycarDataExternalQueryResponse> getResponseClass() {
		return AlipayEcoMycarDataExternalQueryResponse.class;
	}
