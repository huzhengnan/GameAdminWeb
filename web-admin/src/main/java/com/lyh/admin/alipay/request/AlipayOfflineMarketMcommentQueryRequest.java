...
import com.lyh.admin.alipay.response.AlipayOfflineMarketMcommentQueryResponse;
...
public class AlipayOfflineMarketMcommentQueryRequest implements AlipayRequest<AlipayOfflineMarketMcommentQueryResponse> {
	...
	* 查询交易评价信息
	...
	public Class<AlipayOfflineMarketMcommentQueryResponse> getResponseClass() {
		return AlipayOfflineMarketMcommentQueryResponse.class;
	}
