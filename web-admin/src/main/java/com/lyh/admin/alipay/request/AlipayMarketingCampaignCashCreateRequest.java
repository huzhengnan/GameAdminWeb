...
import com.lyh.admin.alipay.response.AlipayMarketingCampaignCashCreateResponse;
...
public class AlipayMarketingCampaignCashCreateRequest implements AlipayRequest<AlipayMarketingCampaignCashCreateResponse> {
	...
	* 创建现金活动
	...
	public Class<AlipayMarketingCampaignCashCreateResponse> getResponseClass() {
		return AlipayMarketingCampaignCashCreateResponse.class;
	}
