...
import com.lyh.admin.alipay.response.ZhimaCreditWatchlistiiGetResponse;
...
public class ZhimaCreditWatchlistiiGetRequest implements AlipayRequest<ZhimaCreditWatchlistiiGetResponse> {
	...
	* 行业关注名单
	...
	public Class<ZhimaCreditWatchlistiiGetResponse> getResponseClass() {
		return ZhimaCreditWatchlistiiGetResponse.class;
	}
