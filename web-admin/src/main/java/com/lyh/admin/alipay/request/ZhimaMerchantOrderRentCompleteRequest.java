...
import com.lyh.admin.alipay.response.ZhimaMerchantOrderRentCompleteResponse;
...
public class ZhimaMerchantOrderRentCompleteRequest implements AlipayRequest<ZhimaMerchantOrderRentCompleteResponse> {
	...
	* 信用借还订单归还
	...
	public Class<ZhimaMerchantOrderRentCompleteResponse> getResponseClass() {
		return ZhimaMerchantOrderRentCompleteResponse.class;
	}
