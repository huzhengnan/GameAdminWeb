...
import com.lyh.admin.alipay.response.AlipayFundAuthOrderVoucherCreateResponse;
...
public class AlipayFundAuthOrderVoucherCreateRequest implements AlipayRequest<AlipayFundAuthOrderVoucherCreateResponse> {
	...
	* 资金授权发码接口
	...
	public Class<AlipayFundAuthOrderVoucherCreateResponse> getResponseClass() {
		return AlipayFundAuthOrderVoucherCreateResponse.class;
	}
