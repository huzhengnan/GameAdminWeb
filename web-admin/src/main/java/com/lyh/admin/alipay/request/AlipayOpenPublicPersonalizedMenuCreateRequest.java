...
import com.lyh.admin.alipay.response.AlipayOpenPublicPersonalizedMenuCreateResponse;
...
public class AlipayOpenPublicPersonalizedMenuCreateRequest implements AlipayRequest<AlipayOpenPublicPersonalizedMenuCreateResponse> {
	...
	* 个性化菜单创建
	...
	public Class<AlipayOpenPublicPersonalizedMenuCreateResponse> getResponseClass() {
		return AlipayOpenPublicPersonalizedMenuCreateResponse.class;
	}
