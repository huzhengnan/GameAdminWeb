...
import com.lyh.admin.alipay.response.AntMerchantExpandMapplyorderQueryResponse;
...
public class AntMerchantExpandMapplyorderQueryRequest implements AlipayRequest<AntMerchantExpandMapplyorderQueryResponse> {
	...
	* 商户入驻单查询接口
	...
	public Class<AntMerchantExpandMapplyorderQueryResponse> getResponseClass() {
		return AntMerchantExpandMapplyorderQueryResponse.class;
	}
