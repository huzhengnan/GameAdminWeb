...
import com.lyh.admin.alipay.response.AlipayDataDataserviceCodeRecoResponse;
...
public class AlipayDataDataserviceCodeRecoRequest implements AlipayRequest<AlipayDataDataserviceCodeRecoResponse> {
	...
	* 改api为数立提供验证码识别服务。isv可以通过该接口，使用我们的图片识别能力。
	...
	public Class<AlipayDataDataserviceCodeRecoResponse> getResponseClass() {
		return AlipayDataDataserviceCodeRecoResponse.class;
	}
