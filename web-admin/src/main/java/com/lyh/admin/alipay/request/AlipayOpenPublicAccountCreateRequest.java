...
import com.lyh.admin.alipay.response.AlipayOpenPublicAccountCreateResponse;
...
public class AlipayOpenPublicAccountCreateRequest implements AlipayRequest<AlipayOpenPublicAccountCreateResponse> {
	...
	* 添加绑定商户会员号
	...
	public Class<AlipayOpenPublicAccountCreateResponse> getResponseClass() {
		return AlipayOpenPublicAccountCreateResponse.class;
	}
