...
import com.lyh.admin.alipay.response.AlipayOpenPublicLifeAgentcreateQueryResponse;
...
public class AlipayOpenPublicLifeAgentcreateQueryRequest implements AlipayRequest<AlipayOpenPublicLifeAgentcreateQueryResponse> {
	...
	* isv代创建生活号申请状态查询接口
	...
	public Class<AlipayOpenPublicLifeAgentcreateQueryResponse> getResponseClass() {
		return AlipayOpenPublicLifeAgentcreateQueryResponse.class;
	}
