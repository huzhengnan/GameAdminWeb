...
import com.lyh.admin.alipay.response.KoubeiMemberBrandownerNameQueryResponse;
...
public class KoubeiMemberBrandownerNameQueryRequest implements AlipayRequest<KoubeiMemberBrandownerNameQueryResponse> {
	...
	public Class<KoubeiMemberBrandownerNameQueryResponse> getResponseClass() {
		return KoubeiMemberBrandownerNameQueryResponse.class;
	}
