...
import com.lyh.admin.alipay.response.AlipayMarketingCampaignDiscountOperateResponse;
...
public class AlipayMarketingCampaignDiscountOperateRequest implements AlipayRequest<AlipayMarketingCampaignDiscountOperateResponse> {
	...
	* 支付宝营销优惠立减活动操作
	...
	public Class<AlipayMarketingCampaignDiscountOperateResponse> getResponseClass() {
		return AlipayMarketingCampaignDiscountOperateResponse.class;
	}
