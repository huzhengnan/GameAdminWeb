...
import com.lyh.admin.alipay.response.ZhimaMerchantBorrowEntityUploadResponse;
...
public class ZhimaMerchantBorrowEntityUploadRequest implements AlipayRequest<ZhimaMerchantBorrowEntityUploadResponse> {
	...
	* 信用借还借用实体数据上传接口
	...
	public Class<ZhimaMerchantBorrowEntityUploadResponse> getResponseClass() {
		return ZhimaMerchantBorrowEntityUploadResponse.class;
	}
