...
import com.lyh.admin.alipay.response.AntMerchantExpandContractFacetofaceQueryResponse;
...
public class AntMerchantExpandContractFacetofaceQueryRequest implements AlipayRequest<AntMerchantExpandContractFacetofaceQueryResponse> {
	...
	* 当面付申请查询接口
	...
	public Class<AntMerchantExpandContractFacetofaceQueryResponse> getResponseClass() {
		return AntMerchantExpandContractFacetofaceQueryResponse.class;
	}
