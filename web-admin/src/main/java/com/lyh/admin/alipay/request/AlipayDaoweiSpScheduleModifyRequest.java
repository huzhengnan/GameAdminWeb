...
import com.lyh.admin.alipay.response.AlipayDaoweiSpScheduleModifyResponse;
...
public class AlipayDaoweiSpScheduleModifyRequest implements AlipayRequest<AlipayDaoweiSpScheduleModifyResponse> {
	...
	* 更新服务者可用时间接口
	...
	public Class<AlipayDaoweiSpScheduleModifyResponse> getResponseClass() {
		return AlipayDaoweiSpScheduleModifyResponse.class;
	}
