...
import com.lyh.admin.alipay.response.KoubeiMarketingToolIsvMerchantQueryResponse;
...
public class KoubeiMarketingToolIsvMerchantQueryRequest implements AlipayRequest<KoubeiMarketingToolIsvMerchantQueryResponse> {
	...
	public Class<KoubeiMarketingToolIsvMerchantQueryResponse> getResponseClass() {
		return KoubeiMarketingToolIsvMerchantQueryResponse.class;
	}
