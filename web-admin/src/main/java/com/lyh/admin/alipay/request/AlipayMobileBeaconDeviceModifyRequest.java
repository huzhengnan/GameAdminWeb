...
import com.lyh.admin.alipay.response.AlipayMobileBeaconDeviceModifyResponse;
...
public class AlipayMobileBeaconDeviceModifyRequest implements AlipayRequest<AlipayMobileBeaconDeviceModifyResponse> {
	...
	* 设备信息，格式为JSON字符串
	...
	public Class<AlipayMobileBeaconDeviceModifyResponse> getResponseClass() {
		return AlipayMobileBeaconDeviceModifyResponse.class;
	}
