...
import com.lyh.admin.alipay.response.AlipayMobileBeaconDeviceDeleteResponse;
...
public class AlipayMobileBeaconDeviceDeleteRequest implements AlipayRequest<AlipayMobileBeaconDeviceDeleteResponse> {
	...
	* 删除的设备的UUID
	...
	public Class<AlipayMobileBeaconDeviceDeleteResponse> getResponseClass() {
		return AlipayMobileBeaconDeviceDeleteResponse.class;
	}
