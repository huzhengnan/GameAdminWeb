...
import com.lyh.admin.alipay.response.KoubeiMarketingCampaignTagsQueryResponse;
...
public class KoubeiMarketingCampaignTagsQueryRequest implements AlipayRequest<KoubeiMarketingCampaignTagsQueryResponse> {
	...
	public Class<KoubeiMarketingCampaignTagsQueryResponse> getResponseClass() {
		return KoubeiMarketingCampaignTagsQueryResponse.class;
	}
