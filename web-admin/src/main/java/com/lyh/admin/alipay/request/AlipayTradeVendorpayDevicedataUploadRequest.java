...
import com.lyh.admin.alipay.response.AlipayTradeVendorpayDevicedataUploadResponse;
...
public class AlipayTradeVendorpayDevicedataUploadRequest implements AlipayRequest<AlipayTradeVendorpayDevicedataUploadResponse> {
	...
	* 厂商支付授权时上传设备数据接口，目前主要包含三星支付。com
	...
	public Class<AlipayTradeVendorpayDevicedataUploadResponse> getResponseClass() {
		return AlipayTradeVendorpayDevicedataUploadResponse.class;
	}
