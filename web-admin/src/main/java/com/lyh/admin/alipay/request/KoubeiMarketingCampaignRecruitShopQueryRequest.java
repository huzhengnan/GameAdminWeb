...
import com.lyh.admin.alipay.response.KoubeiMarketingCampaignRecruitShopQueryResponse;
...
public class KoubeiMarketingCampaignRecruitShopQueryRequest implements AlipayRequest<KoubeiMarketingCampaignRecruitShopQueryResponse> {
	...
	* 招商门店分页查询接口
	...
	public Class<KoubeiMarketingCampaignRecruitShopQueryResponse> getResponseClass() {
		return KoubeiMarketingCampaignRecruitShopQueryResponse.class;
	}
