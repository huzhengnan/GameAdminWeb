...
import com.lyh.admin.alipay.response.AlipayMobileStdPublicAccountQueryResponse;
...
public class AlipayMobileStdPublicAccountQueryRequest implements AlipayRequest<AlipayMobileStdPublicAccountQueryResponse> {
	...
	* 业务信息：userId，这是个json字段
	...
	public Class<AlipayMobileStdPublicAccountQueryResponse> getResponseClass() {
		return AlipayMobileStdPublicAccountQueryResponse.class;
	}
