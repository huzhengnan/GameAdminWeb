...
import com.lyh.admin.alipay.response.AlipayOpenPublicLabelUserCreateResponse;
...
public class AlipayOpenPublicLabelUserCreateRequest implements AlipayRequest<AlipayOpenPublicLabelUserCreateResponse> {
	...
	* 用户增加标签接口
	...
	public Class<AlipayOpenPublicLabelUserCreateResponse> getResponseClass() {
		return AlipayOpenPublicLabelUserCreateResponse.class;
	}
