...
import com.lyh.admin.alipay.response.AlipayInsSceneApplicationIssueConfirmResponse;
...
public class AlipayInsSceneApplicationIssueConfirmRequest implements AlipayRequest<AlipayInsSceneApplicationIssueConfirmResponse> {
	...
	* 投保订单出单确认
	...
	public Class<AlipayInsSceneApplicationIssueConfirmResponse> getResponseClass() {
		return AlipayInsSceneApplicationIssueConfirmResponse.class;
	}
