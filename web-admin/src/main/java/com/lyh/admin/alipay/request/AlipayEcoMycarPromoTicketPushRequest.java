...
import com.lyh.admin.alipay.response.AlipayEcoMycarPromoTicketPushResponse;
...
public class AlipayEcoMycarPromoTicketPushRequest implements AlipayRequest<AlipayEcoMycarPromoTicketPushResponse> {
	...
	* 车主营销平台券核销结果通知
	...
	public Class<AlipayEcoMycarPromoTicketPushResponse> getResponseClass() {
		return AlipayEcoMycarPromoTicketPushResponse.class;
	}
