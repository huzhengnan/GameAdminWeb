...
import com.lyh.admin.alipay.response.AlipayUserInfoAuthResponse;
...
public class AlipayUserInfoAuthRequest implements AlipayRequest<AlipayUserInfoAuthResponse> {
	...
	* 用户登陆授权
	...
	public Class<AlipayUserInfoAuthResponse> getResponseClass() {
		return AlipayUserInfoAuthResponse.class;
	}
