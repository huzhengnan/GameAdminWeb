...
import com.lyh.admin.alipay.response.AlipayOfflineMarketShopCategoryQueryResponse;
...
public class AlipayOfflineMarketShopCategoryQueryRequest implements AlipayRequest<AlipayOfflineMarketShopCategoryQueryResponse> {
	...
	* 门店类目配置查询接口
	...
	public Class<AlipayOfflineMarketShopCategoryQueryResponse> getResponseClass() {
		return AlipayOfflineMarketShopCategoryQueryResponse.class;
	}
