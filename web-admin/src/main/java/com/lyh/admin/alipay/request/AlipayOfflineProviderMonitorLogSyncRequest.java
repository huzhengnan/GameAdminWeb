...
import com.lyh.admin.alipay.response.AlipayOfflineProviderMonitorLogSyncResponse;
...
public class AlipayOfflineProviderMonitorLogSyncRequest implements AlipayRequest<AlipayOfflineProviderMonitorLogSyncResponse> {
	...
	* ISV服务商监控数据回流
	...
	public Class<AlipayOfflineProviderMonitorLogSyncResponse> getResponseClass() {
		return AlipayOfflineProviderMonitorLogSyncResponse.class;
	}
