...
import com.lyh.admin.alipay.response.KoubeiMarketingToolPrizesendAuthResponse;
...
public class KoubeiMarketingToolPrizesendAuthRequest implements AlipayRequest<KoubeiMarketingToolPrizesendAuthResponse> {
	...
	* 发券授权
	...
	public Class<KoubeiMarketingToolPrizesendAuthResponse> getResponseClass() {
		return KoubeiMarketingToolPrizesendAuthResponse.class;
	}
