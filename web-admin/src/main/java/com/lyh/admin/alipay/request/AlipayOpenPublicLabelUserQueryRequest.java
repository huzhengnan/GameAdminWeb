...
import com.lyh.admin.alipay.response.AlipayOpenPublicLabelUserQueryResponse;
...
public class AlipayOpenPublicLabelUserQueryRequest implements AlipayRequest<AlipayOpenPublicLabelUserQueryResponse> {
	...
	* 公众号标签管理-查询用户标签
	...
	public Class<AlipayOpenPublicLabelUserQueryResponse> getResponseClass() {
		return AlipayOpenPublicLabelUserQueryResponse.class;
	}
