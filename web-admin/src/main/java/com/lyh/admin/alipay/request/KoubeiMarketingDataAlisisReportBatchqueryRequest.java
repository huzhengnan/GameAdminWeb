...
import com.lyh.admin.alipay.response.KoubeiMarketingDataAlisisReportBatchqueryResponse;
...
public class KoubeiMarketingDataAlisisReportBatchqueryRequest implements AlipayRequest<KoubeiMarketingDataAlisisReportBatchqueryResponse> {
	...
	* 报表列表查询接口
	...
	public Class<KoubeiMarketingDataAlisisReportBatchqueryResponse> getResponseClass() {
		return KoubeiMarketingDataAlisisReportBatchqueryResponse.class;
	}
