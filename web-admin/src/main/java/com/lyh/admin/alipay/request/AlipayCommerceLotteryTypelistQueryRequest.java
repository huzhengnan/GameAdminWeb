...
import com.lyh.admin.alipay.response.AlipayCommerceLotteryTypelistQueryResponse;
...
public class AlipayCommerceLotteryTypelistQueryRequest implements AlipayRequest<AlipayCommerceLotteryTypelistQueryResponse> {
	...
	public Class<AlipayCommerceLotteryTypelistQueryResponse> getResponseClass() {
		return AlipayCommerceLotteryTypelistQueryResponse.class;
	}
