...
import com.lyh.admin.alipay.response.ZhimaOpenAppKeyanLqlCreateResponse;
...
public class ZhimaOpenAppKeyanLqlCreateRequest implements AlipayRequest<ZhimaOpenAppKeyanLqlCreateResponse> {
	...
	* keyantestoneone
	...
	public Class<ZhimaOpenAppKeyanLqlCreateResponse> getResponseClass() {
		return ZhimaOpenAppKeyanLqlCreateResponse.class;
	}
