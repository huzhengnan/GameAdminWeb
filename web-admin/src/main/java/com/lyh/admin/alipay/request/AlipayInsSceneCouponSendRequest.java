...
import com.lyh.admin.alipay.response.AlipayInsSceneCouponSendResponse;
...
public class AlipayInsSceneCouponSendRequest implements AlipayRequest<AlipayInsSceneCouponSendResponse> {
	...
	* 保险营销权益发放接口
	...
	public Class<AlipayInsSceneCouponSendResponse> getResponseClass() {
		return AlipayInsSceneCouponSendResponse.class;
	}
