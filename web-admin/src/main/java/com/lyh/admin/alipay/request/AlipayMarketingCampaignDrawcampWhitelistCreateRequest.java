...
import com.lyh.admin.alipay.response.AlipayMarketingCampaignDrawcampWhitelistCreateResponse;
...
public class AlipayMarketingCampaignDrawcampWhitelistCreateRequest implements AlipayRequest<AlipayMarketingCampaignDrawcampWhitelistCreateResponse> {
	...
	* 营销抽奖活动白名单创建
	...
	public Class<AlipayMarketingCampaignDrawcampWhitelistCreateResponse> getResponseClass() {
		return AlipayMarketingCampaignDrawcampWhitelistCreateResponse.class;
	}
