...
import com.lyh.admin.alipay.response.AlipayMarketingCardConsumeSyncResponse;
...
public class AlipayMarketingCardConsumeSyncRequest implements AlipayRequest<AlipayMarketingCardConsumeSyncResponse> {
	...
	* 会员卡消费记录同步
	...
	public Class<AlipayMarketingCardConsumeSyncResponse> getResponseClass() {
		return AlipayMarketingCardConsumeSyncResponse.class;
	}
