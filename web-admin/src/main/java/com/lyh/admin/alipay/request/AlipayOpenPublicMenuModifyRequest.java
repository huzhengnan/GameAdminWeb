...
import com.lyh.admin.alipay.response.AlipayOpenPublicMenuModifyResponse;
...
public class AlipayOpenPublicMenuModifyRequest implements AlipayRequest<AlipayOpenPublicMenuModifyResponse> {
	...
	* 更新菜单
	...
	public Class<AlipayOpenPublicMenuModifyResponse> getResponseClass() {
		return AlipayOpenPublicMenuModifyResponse.class;
	}
