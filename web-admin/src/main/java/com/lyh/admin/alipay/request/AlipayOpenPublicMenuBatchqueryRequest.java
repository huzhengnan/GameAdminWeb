...
import com.lyh.admin.alipay.response.AlipayOpenPublicMenuBatchqueryResponse;
...
public class AlipayOpenPublicMenuBatchqueryRequest implements AlipayRequest<AlipayOpenPublicMenuBatchqueryResponse> {
	...
	public Class<AlipayOpenPublicMenuBatchqueryResponse> getResponseClass() {
		return AlipayOpenPublicMenuBatchqueryResponse.class;
	}
