...
import com.lyh.admin.alipay.response.AlipayCommerceCityfacilitatorCityQueryResponse;
...
public class AlipayCommerceCityfacilitatorCityQueryRequest implements AlipayRequest<AlipayCommerceCityfacilitatorCityQueryResponse> {
	...
	public Class<AlipayCommerceCityfacilitatorCityQueryResponse> getResponseClass() {
		return AlipayCommerceCityfacilitatorCityQueryResponse.class;
	}
