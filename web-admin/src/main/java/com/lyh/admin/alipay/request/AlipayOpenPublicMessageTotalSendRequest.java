...
import com.lyh.admin.alipay.response.AlipayOpenPublicMessageTotalSendResponse;
...
public class AlipayOpenPublicMessageTotalSendRequest implements AlipayRequest<AlipayOpenPublicMessageTotalSendResponse> {
	...
	* alipay.open.public. message.total.send（群发消息）
	...
	public Class<AlipayOpenPublicMessageTotalSendResponse> getResponseClass() {
		return AlipayOpenPublicMessageTotalSendResponse.class;
	}
