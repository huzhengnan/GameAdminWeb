...
import com.lyh.admin.alipay.response.AlipayCommerceTransportOfflinepayRecordVerifyResponse;
...
public class AlipayCommerceTransportOfflinepayRecordVerifyRequest implements AlipayRequest<AlipayCommerceTransportOfflinepayRecordVerifyResponse> {
	...
	* 支付宝脱机操作信息验证
	...
	public Class<AlipayCommerceTransportOfflinepayRecordVerifyResponse> getResponseClass() {
		return AlipayCommerceTransportOfflinepayRecordVerifyResponse.class;
	}
