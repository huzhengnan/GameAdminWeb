...
import com.lyh.admin.alipay.response.ZhimaMerchantOrderRentCancelResponse;
...
public class ZhimaMerchantOrderRentCancelRequest implements AlipayRequest<ZhimaMerchantOrderRentCancelResponse> {
	...
	* 信用借还撤销订单
	...
	public Class<ZhimaMerchantOrderRentCancelResponse> getResponseClass() {
		return ZhimaMerchantOrderRentCancelResponse.class;
	}
