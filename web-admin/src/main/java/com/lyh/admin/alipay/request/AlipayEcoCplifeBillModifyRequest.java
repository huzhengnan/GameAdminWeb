...
import com.lyh.admin.alipay.response.AlipayEcoCplifeBillModifyResponse;
...
public class AlipayEcoCplifeBillModifyRequest implements AlipayRequest<AlipayEcoCplifeBillModifyResponse> {
	...
	* 修改已上传的物业费账单数据
	...
	public Class<AlipayEcoCplifeBillModifyResponse> getResponseClass() {
		return AlipayEcoCplifeBillModifyResponse.class;
	}
