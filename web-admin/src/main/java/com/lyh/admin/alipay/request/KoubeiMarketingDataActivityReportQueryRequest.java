...
import com.lyh.admin.alipay.response.KoubeiMarketingDataActivityReportQueryResponse;
...
public class KoubeiMarketingDataActivityReportQueryRequest implements AlipayRequest<KoubeiMarketingDataActivityReportQueryResponse> {
	...
	* 口碑商户营销报表查询
	...
	public Class<KoubeiMarketingDataActivityReportQueryResponse> getResponseClass() {
		return KoubeiMarketingDataActivityReportQueryResponse.class;
	}
