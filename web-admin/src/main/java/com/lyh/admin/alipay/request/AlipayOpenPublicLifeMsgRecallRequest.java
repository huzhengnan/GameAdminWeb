...
import com.lyh.admin.alipay.response.AlipayOpenPublicLifeMsgRecallResponse;
...
public class AlipayOpenPublicLifeMsgRecallRequest implements AlipayRequest<AlipayOpenPublicLifeMsgRecallResponse> {
	...
	* 生活号消息撤回接口
	...
	public Class<AlipayOpenPublicLifeMsgRecallResponse> getResponseClass() {
		return AlipayOpenPublicLifeMsgRecallResponse.class;
	}
