...
import com.lyh.admin.alipay.response.AlipayCommerceLotteryPresentlistQueryResponse;
...
public class AlipayCommerceLotteryPresentlistQueryRequest implements AlipayRequest<AlipayCommerceLotteryPresentlistQueryResponse> {
	...
	* 查询调用者指定时间范围内的彩票赠送列表，由亚博科技提供服务
	...
	public Class<AlipayCommerceLotteryPresentlistQueryResponse> getResponseClass() {
		return AlipayCommerceLotteryPresentlistQueryResponse.class;
	}
