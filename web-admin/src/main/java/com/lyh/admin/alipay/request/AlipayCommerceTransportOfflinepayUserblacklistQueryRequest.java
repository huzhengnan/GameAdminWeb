...
import com.lyh.admin.alipay.response.AlipayCommerceTransportOfflinepayUserblacklistQueryResponse;
...
public class AlipayCommerceTransportOfflinepayUserblacklistQueryRequest implements AlipayRequest<AlipayCommerceTransportOfflinepayUserblacklistQueryResponse> {
	...
	* 脱机交易黑名单列表
	...
	public Class<AlipayCommerceTransportOfflinepayUserblacklistQueryResponse> getResponseClass() {
		return AlipayCommerceTransportOfflinepayUserblacklistQueryResponse.class;
	}
