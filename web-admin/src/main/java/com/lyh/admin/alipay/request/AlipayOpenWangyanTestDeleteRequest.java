...
import com.lyh.admin.alipay.response.AlipayOpenWangyanTestDeleteResponse;
...
public class AlipayOpenWangyanTestDeleteRequest implements AlipayRequest<AlipayOpenWangyanTestDeleteResponse> {
	...
	* 测试接口
	...
	public String getApiMethodName() {
		return "alipay.open.wangyan.test.delete";
	}
	...
	public Class<AlipayOpenWangyanTestDeleteResponse> getResponseClass() {
		return AlipayOpenWangyanTestDeleteResponse.class;
	}
