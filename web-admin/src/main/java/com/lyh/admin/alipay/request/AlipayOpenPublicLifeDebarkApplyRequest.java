...
import com.lyh.admin.alipay.response.AlipayOpenPublicLifeDebarkApplyResponse;
...
public class AlipayOpenPublicLifeDebarkApplyRequest implements AlipayRequest<AlipayOpenPublicLifeDebarkApplyResponse> {
	...
	public Class<AlipayOpenPublicLifeDebarkApplyResponse> getResponseClass() {
		return AlipayOpenPublicLifeDebarkApplyResponse.class;
	}
