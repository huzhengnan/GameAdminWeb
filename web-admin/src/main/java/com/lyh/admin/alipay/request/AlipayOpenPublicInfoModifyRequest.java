...
import com.lyh.admin.alipay.response.AlipayOpenPublicInfoModifyResponse;
...
public class AlipayOpenPublicInfoModifyRequest implements AlipayRequest<AlipayOpenPublicInfoModifyResponse> {
	...
	* 服务窗基础信息修改接口
	...
	public Class<AlipayOpenPublicInfoModifyResponse> getResponseClass() {
		return AlipayOpenPublicInfoModifyResponse.class;
	}
