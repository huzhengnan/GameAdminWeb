...
import com.lyh.admin.alipay.response.AlipayUserAccountUseridBatchqueryResponse;
...
public class AlipayUserAccountUseridBatchqueryRequest implements AlipayRequest<AlipayUserAccountUseridBatchqueryResponse> {
	...
	* 业务统一入参，目前会传入用户的手机号作为查询参数
	...
	public Class<AlipayUserAccountUseridBatchqueryResponse> getResponseClass() {
		return AlipayUserAccountUseridBatchqueryResponse.class;
	}
