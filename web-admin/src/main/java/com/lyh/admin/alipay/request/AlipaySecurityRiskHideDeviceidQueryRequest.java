...
import com.lyh.admin.alipay.response.AlipaySecurityRiskHideDeviceidQueryResponse;
...
public class AlipaySecurityRiskHideDeviceidQueryRequest implements AlipayRequest<AlipaySecurityRiskHideDeviceidQueryResponse> {
	...
	* 设备指纹查询接口
	...
	public Class<AlipaySecurityRiskHideDeviceidQueryResponse> getResponseClass() {
		return AlipaySecurityRiskHideDeviceidQueryResponse.class;
	}
