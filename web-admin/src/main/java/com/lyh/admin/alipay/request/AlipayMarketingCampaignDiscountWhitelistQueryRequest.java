...
import com.lyh.admin.alipay.response.AlipayMarketingCampaignDiscountWhitelistQueryResponse;
...
public class AlipayMarketingCampaignDiscountWhitelistQueryRequest implements AlipayRequest<AlipayMarketingCampaignDiscountWhitelistQueryResponse> {
	...
	* 优惠活动白名单查询
	...
	public Class<AlipayMarketingCampaignDiscountWhitelistQueryResponse> getResponseClass() {
		return AlipayMarketingCampaignDiscountWhitelistQueryResponse.class;
	}
