...
import com.lyh.admin.alipay.response.AlipayMsaasPromotionCpainfoCreateResponse;
...
public class AlipayMsaasPromotionCpainfoCreateRequest implements AlipayRequest<AlipayMsaasPromotionCpainfoCreateResponse> {
	...
	* 此api为了让第三方渠道端调用 ，记录他们的调用数据，然后根据数据比对进行计费功能
	...
	public Class<AlipayMsaasPromotionCpainfoCreateResponse> getResponseClass() {
		return AlipayMsaasPromotionCpainfoCreateResponse.class;
	}
