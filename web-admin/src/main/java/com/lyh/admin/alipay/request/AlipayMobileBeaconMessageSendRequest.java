...
import com.lyh.admin.alipay.response.AlipayMobileBeaconMessageSendResponse;
...
public class AlipayMobileBeaconMessageSendRequest implements AlipayRequest<AlipayMobileBeaconMessageSendResponse> {
	...
	* 设备关联数据
	...
	public Class<AlipayMobileBeaconMessageSendResponse> getResponseClass() {
		return AlipayMobileBeaconMessageSendResponse.class;
	}
