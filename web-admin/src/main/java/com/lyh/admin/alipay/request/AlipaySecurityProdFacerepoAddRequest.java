...
import com.lyh.admin.alipay.response.AlipaySecurityProdFacerepoAddResponse;
...
public class AlipaySecurityProdFacerepoAddRequest implements AlipayRequest<AlipaySecurityProdFacerepoAddResponse> {
	...
	* 人脸1:N服务入库接口
	...
	public Class<AlipaySecurityProdFacerepoAddResponse> getResponseClass() {
		return AlipaySecurityProdFacerepoAddResponse.class;
	}
