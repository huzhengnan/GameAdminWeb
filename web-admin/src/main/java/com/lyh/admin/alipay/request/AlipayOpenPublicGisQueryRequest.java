...
import com.lyh.admin.alipay.response.AlipayOpenPublicGisQueryResponse;
...
public class AlipayOpenPublicGisQueryRequest implements AlipayRequest<AlipayOpenPublicGisQueryResponse> {
	...
	* 获取用户地理位置
	...
	public Class<AlipayOpenPublicGisQueryResponse> getResponseClass() {
		return AlipayOpenPublicGisQueryResponse.class;
	}
