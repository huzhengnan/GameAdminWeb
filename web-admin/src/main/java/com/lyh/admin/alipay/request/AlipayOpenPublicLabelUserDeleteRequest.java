...
import com.lyh.admin.alipay.response.AlipayOpenPublicLabelUserDeleteResponse;
...
public class AlipayOpenPublicLabelUserDeleteRequest implements AlipayRequest<AlipayOpenPublicLabelUserDeleteResponse> {
	...
	* 公众号标签管理-删除用户标签
	...
	public Class<AlipayOpenPublicLabelUserDeleteResponse> getResponseClass() {
		return AlipayOpenPublicLabelUserDeleteResponse.class;
	}
