...
import com.lyh.admin.alipay.response.AlipayOpenAuthTokenAppQueryResponse;
 ...
 */
public class AlipayOpenAuthTokenAppQueryRequest implements AlipayRequest<AlipayOpenAuthTokenAppQueryResponse> {
	...
	* 查询某个ISV下的指定app_auth_token的授权信息：授权者、授权接口列表、状态、过期时间等
	...
	public Class<AlipayOpenAuthTokenAppQueryResponse> getResponseClass() {
		return AlipayOpenAuthTokenAppQueryResponse.class;
	}
