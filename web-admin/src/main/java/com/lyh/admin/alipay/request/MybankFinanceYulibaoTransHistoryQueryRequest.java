...
import com.lyh.admin.alipay.response.MybankFinanceYulibaoTransHistoryQueryResponse;
...
public class MybankFinanceYulibaoTransHistoryQueryRequest implements AlipayRequest<MybankFinanceYulibaoTransHistoryQueryResponse> {
	...
	* 余利宝历史交易查询
	...
	public Class<MybankFinanceYulibaoTransHistoryQueryResponse> getResponseClass() {
		return MybankFinanceYulibaoTransHistoryQueryResponse.class;
	}
