...
import com.lyh.admin.alipay.response.AlipayOpenServicemarketOrderNotifyResponse;
...
public class AlipayOpenServicemarketOrderNotifyRequest implements AlipayRequest<AlipayOpenServicemarketOrderNotifyResponse> {
	...
	public Class<AlipayOpenServicemarketOrderNotifyResponse> getResponseClass() {
		return AlipayOpenServicemarketOrderNotifyResponse.class;
	}
