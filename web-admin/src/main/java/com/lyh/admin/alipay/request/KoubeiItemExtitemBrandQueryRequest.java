...
import com.lyh.admin.alipay.response.KoubeiItemExtitemBrandQueryResponse;
...
public class KoubeiItemExtitemBrandQueryRequest implements AlipayRequest<KoubeiItemExtitemBrandQueryResponse> {
	...
	public Class<KoubeiItemExtitemBrandQueryResponse> getResponseClass() {
		return KoubeiItemExtitemBrandQueryResponse.class;
	}
