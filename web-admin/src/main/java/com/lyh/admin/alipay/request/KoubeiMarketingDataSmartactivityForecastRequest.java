...
import com.lyh.admin.alipay.response.KoubeiMarketingDataSmartactivityForecastResponse;
...
public class KoubeiMarketingDataSmartactivityForecastRequest implements AlipayRequest<KoubeiMarketingDataSmartactivityForecastResponse> {
	...
	* 商户智能活动效果预测接口
	...
	public Class<KoubeiMarketingDataSmartactivityForecastResponse> getResponseClass() {
		return KoubeiMarketingDataSmartactivityForecastResponse.class;
	}
