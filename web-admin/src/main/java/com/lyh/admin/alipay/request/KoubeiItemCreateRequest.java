...
import com.lyh.admin.alipay.response.KoubeiItemCreateResponse;
...
public class KoubeiItemCreateRequest implements AlipayRequest<KoubeiItemCreateResponse> {
	...
	* 口碑商品创建接口
	...
	public Class<KoubeiItemCreateResponse> getResponseClass() {
		return KoubeiItemCreateResponse.class;
	}
