...
import com.lyh.admin.alipay.response.AlipayMarketingCardBenefitModifyResponse;
...
public class AlipayMarketingCardBenefitModifyRequest implements AlipayRequest<AlipayMarketingCardBenefitModifyResponse> {
	...
	* 会员卡模板外部权益修改
	...
	public Class<AlipayMarketingCardBenefitModifyResponse> getResponseClass() {
		return AlipayMarketingCardBenefitModifyResponse.class;
	}
